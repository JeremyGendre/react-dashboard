...
export default function HeaderProfile() {
    ...
    return (
        <div className="relative flex flex-col">
            ...
            <div ref={menu} className={(showMenu ? 'flex flex-col' : 'hidden') + " profile-submenu absolute top-0 right-0 transform translate-y-14 bg-gray-600 text-white shadow-md rounded p-1"}>
